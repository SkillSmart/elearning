...
class _TrainerCourseManager extends Component {
    ...
    render() {
        ...
        let {title, summary} = this.state.selectedCourse;
        return (
            <div className={className}>
                <h2>Published Courses</h2>
                <CardGallery className="courses">
                    <div className="courses_statsCard">
                        <div className="courses_statsCard_front">
                        ...
                        <div className="courses_statsCard_back">
